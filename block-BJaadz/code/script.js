...
let p =document.createElement('p').innerText = "Append inserts as last child" ;
...
let p2 =document.createElement('p').innerText = "Prepend inserts as first child" ;
...
imgElm.src = "https://images.unsplash.com";
